            ...
            <Grid className="about-grid">
                <Cell col={4}>
                    <div className="about-left-col">
                        <h3>Personal</h3>
                        <p>
                            I am a father of a four year old and have been with my partner for six years. Both are an integral piece of my life and are an inspiration to kick off my 
                            awesome programming career. I have lived in Vancouver, Washington for all of my life and with the start of my career, look forward to a potential move. 
                        </p>
                        <p>
                ...
                <Cell col={4}>
                    ...
                    <div className="about-mid-col">
                        ...
                        <p>
                            ...
                            to Washington State University to finish off my Bacholors degree. 
                        </p>
                    </div>
                </Cell>
